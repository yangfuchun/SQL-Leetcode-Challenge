...
/*
The TIMESTAMPDIFF function is a SQL function that calculates the difference between two timestamps or 
date values and returns the result in a specified unit of time (e.g., seconds, minutes, hours, days, etc.). 
The exact syntax and supported units of time may vary slightly between different database management systems (DBMS) as SQL implementations can differ.
TIMESTAMPDIFF(unit, datetime_expr1, datetime_expr2)
*/

-- SELECT TIMESTAMPDIFF(DAY, '2023-08-22', '2023-08-15');
